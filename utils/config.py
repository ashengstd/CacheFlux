...
CSV_PATH = CURRENT_PATH / config["paths"]["csv_data"]
...
LP_LOG_PATH = LOG_PATH.joinpath("lp.log")
MEMORY_DNN_LOG_PATH = LOG_PATH.joinpath("memory_dnn.log")

BEST_SOLUTION_PATH = LOG_PATH.joinpath("best_solution")
TEST_SOLUTION_PATH = LOG_PATH.joinpath("test_solution")
